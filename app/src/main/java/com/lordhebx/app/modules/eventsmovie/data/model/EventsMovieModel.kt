package com.lordhebx.app.modules.eventsmovie.`data`.model

import com.lordhebx.app.R
import com.lordhebx.app.appcomponents.di.MyApp
import kotlin.String

data class EventsMovieModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtPolls: String? = MyApp.getInstance().resources.getString(R.string.lbl_polls)
  ,
  /**
   * TODO Replace with dynamic value
   */
